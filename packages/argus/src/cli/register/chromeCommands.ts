		...
		subcommands: [
			{
				...
				options: [
					...
					{ flags: '--user-agent <value>', description: 'Startup user agent: regular-chrome or an exact literal value' },
				...
				examples: [
					...
					'argus chrome start --headless --user-agent regular-chrome --url https://example.com',
